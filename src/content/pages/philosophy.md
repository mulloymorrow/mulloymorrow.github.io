...
subtitle: "My philosophy on building human-centered AI"
description: "My philosophy on human-centered AI: building technology that unlocks human potential, democratizes expertise, and solves meaningful problems at scale."
...
- **Augmentation over automation** - AI should unlock new capabilities humans couldn't access before
- **Intelligence multiplied** - One person with great AI tools should be able to do what previously required a team
- **Access democratized** - Expert-level capabilities available to everyone, not just the privileged few
- **Humans empowered** - People maintain agency and control while leveraging AI's computational power
- **Meaningful progress** - Technology that solves real problems and measurably improves lives
...
This philosophy guided my decision to leave a successful role at Spotify to build <a href="https://nalya.ai/vision"><img src="/logos/stealth-ai.png" alt="Nalya logo" style="height: 1.2em; vertical-align: middle; margin-right: 0.25em;" />Nalya</a>—a platform that uses cutting-edge AI not to increase screen time, but to strengthen real-world relationships. It's technically harder to build AI that respects human autonomy. It's also more valuable.
...
- **Psychological safety** - I create environments where people can take risks and learn from failure
- **Diverse perspectives** - I actively recruit varied backgrounds because homogeneous teams build biased systems
- **Clear values** - I ensure every technical decision aligns with human-centered principles
- **Sustainable pace** - I protect my teams from burnout because exhausted people build fragile systems
...
- World-class education becoming accessible to every child on Earth
- Solo founders gaining the capabilities of entire engineering teams
- Scientific discovery accelerating across every discipline
- New tools to tackle climate change, disease, and scarcity
- Human creativity and problem-solving extending to new frontiers
...
## Why Now? Why <a href="https://nalya.ai/vision"><img src="/logos/stealth-ai.png" alt="Nalya logo" style="height: 1.2em; vertical-align: middle; margin-right: 0.25em;" />Nalya</a>?
...
Here's what excites me: I can use cutting-edge AI to help people build richer offline lives. <a href="https://nalya.ai/vision"><img src="/logos/stealth-ai.png" alt="Nalya logo" style="height: 1.2em; vertical-align: middle; margin-right: 0.25em;" />Nalya</a> is my bet that AI's greatest application isn't maximizing screen time—it's helping people strengthen real-world relationships.

I'm building a platform that uses agentic AI, LLMs, and ML systems to:

- Strengthen existing relationships through intelligent nudges and reminders
- Reduce the cognitive load of maintaining meaningful connections
- Facilitate real-world interactions, not replace them
- Prove that sophisticated AI can respect privacy and user autonomy
...
- **Capability unlocked** - How many people can now do things that were previously impossible?
- **Opportunity created** - Am I expanding access or concentrating it?
- **Problems solved** - Am I addressing real human needs at meaningful scale?
- **Teams empowered** - How many engineers have I helped become more capable and effective?
- **Technology advanced** - Am I pushing the boundaries of what's technically possible?
...
- **Founders** building ambitious AI products that unlock new capabilities
- **Engineers** who want to work on technically challenging problems with real impact
- **Investors** backing companies that combine technical excellence with clear vision
- **Researchers** exploring the frontiers of what AI can do
